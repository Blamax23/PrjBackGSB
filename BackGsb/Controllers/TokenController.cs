...
namespace BackGsb.Controllers
{
    public class TokenController : ApiController
    {
        ...
        {
            User user = db.Users.Where(U => U.Pseudo.Equals(login.Username) && U.Password.Equals(login.Password)).FirstOrDefault();
            ...
            if (login != null && user != null)
                isUsernamePasswordValid = (loginrequest.Username == user.Pseudo && loginrequest.Password == user.Password) ? true : false;
        ...
        private string createToken(string username)
        {
            ...
            var token =
            (JwtSecurityToken)
            tokenHandler.CreateJwtSecurityToken(issuer: "https://localhost:44333", audience: "https://localhost:44333",
